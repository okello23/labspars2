                        ...
                        <div class="col-sm-12 mt-3">
                            <div class="d-sm-flex align-items-center">
                                <h5 class="mb-2 mb-sm-0">
                                    @if (!$toggleForm)
                                        Sub Counties (<span class="text-danger fw-bold">{{ $sub_counties->total() }}</span>)
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="btn-group float-right">
                                    {{ $sub_counties->links('vendor.livewire.bootstrap') }}
                                </div>
                            </div>
                        </div>
                    </div> <!-- end tab-content-->
                ...
                <form  @if ($toggleForm) wire:submit.prevent="updatevalue" @else wire:submit.prevent="storevalue" @endif >
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="station_id" class="form-label required">County</label>
                                <select class="form-control selectr" id="county_id"
                                    wire:model.lazy='county_id'>
