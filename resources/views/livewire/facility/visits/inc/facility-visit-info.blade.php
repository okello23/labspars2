<div >
        ...
        <div wire:ignore.self class="modal fade" id="personalModal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form
                        @if ($toggleForm) wire:submit.prevent="updatePersonal" @else wire:submit.prevent="storePersonal" @endif>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input type="text" id="Profession" class="form-control" name="profession"
                                        required wire:model.defer="profession">
                                    @error('profession')
                                        <div class="text-danger text-small">{{ $message }}</div>
                                    @enderror
                                </div>
        ...
        <div wire:ignore.self class="modal fade" id="supervisorModal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form
                        @if ($toggleForm) wire:submit.prevent="updateSupervisor" @else wire:submit.prevent="storeSupervisor" @endif>
                        <div class="modal-body">
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                ...
                                <div class="mb-3 col-md-6">
                                    <label for="contact" class="form-label required">Contact</label>
                                    <input type="nunmber" id="email" class="form-control" name="contact"
                                        required wire:model.defer="contact">
                                    @error('contact')
                                        <div class="text-danger text-small">{{ $message }}</div>
                                    @enderror
                                </div>
    ...
    <div>
        <h4>Laboratory Supply Storage
            <button class="action-ico btn btn-sm btn-success mx-1" data-toggle="modal" data-target="#storageModal"
                wire:click="$set('storage_type','Main Store')">
                Add New
            </button>
        </h4>
        ...
        <h5>D2: Where ELSE are Laboratory supplies stored in the facility?
            <button class="action-ico btn btn-sm btn-success mx-1" data-toggle="modal" data-target="#storageModal"
                wire:click="$set('storage_type','Other Store')">
                Add New
            </button>
        </h5>
        <table class="table" style="width: 100%">
    ...
    <div>
        ...
        <h5>D4: Where are stock cards kept in the facility?
            <button class="action-ico btn btn-sm btn-success mx-1" data-toggle="modal" data-target="#storageModal"
                wire:click="$set('storage_type','Card Store')">
                Add New
            </button>
        </h5>
        <table class="table" style="width: 100%">
