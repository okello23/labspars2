<div>
  ...
  <div class="info-box" style="float:left; width: 100%; overflow-x: auto;  overflow-y: auto;">
    <div class="info-box-content">
      <h4>LSS League Table (<span class="text-danger fw-bold">{{ $visits->total() }}</span>)</h4>
      <div class="progress">
                                ...
                                <tbody>
                                   @foreach ($visits as $key => $facilityvisit)
                                       <tr>
                                           ...
                                           <td>{{ $facilityvisit->facility->healthSubDistrict?->district->region?->name ?? 'N/A' }}</td>
                                           <td>{{ $facilityvisit->stock_management }}</td>
                                            <td>{{ $facilityvisit->storage_management }}</td>
                                            <td>{{ $facilityvisit->ordering_management }}</td>
                                            <td>{{ $facilityvisit->equipment_management }}</td>
                                            <td>{{ $facilityvisit->lis_mgt }}</td>
                                            <td>{{ $facilityvisit->total_score }}</td>
