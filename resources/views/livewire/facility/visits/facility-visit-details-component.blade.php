            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="stepwizard-row setup-panel overflow-auto">
                                <div class="multi-wizard-step overflow-auto">
                                    <a href="#step-1" type="button"
                                        class="btn {{ $step != 1 ? 'btn-default' : 'btn-success' }}">LABORATORY
                                        INFORMATION</a>
                                </div>
                                <div class="multi-wizard-step overflow-auto">
                                    <a href="#step-2" type="button"
                                        class="btn {{ $step != 2 ? 'btn-default' : 'btn-success' }}">STOCK
                                        MANAGEMENT</a>
                                </div>
                                <div class="multi-wizard-step overflow-auto">
                                    <a href="#step-3" type="button"
                                        class="btn {{ $step != 3 ? 'btn-default' : 'btn-success' }}">STORAGE & LAB
                                ...
                                <div class="multi-wizard-step overflow-auto">
                                    <a href="#step-5" type="button"
                                        class="btn {{ $step != 5 ? 'btn-default' : 'btn-success' }}">LABORATORY
                                        EQUIPMENT </a>
                                </div>
                                <div class="multi-wizard-step overflow-auto">
                                    <a href="#step-6" type="button"
                                        class="btn {{ $step != 6 ? 'btn-default' : 'btn-success' }}">LABORATORY
                                    ...
                                    <div class="border border-success rounded p-3">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="btn-group" role="group">
                                                <x-button
                                                    class="btn-danger float-right nextBtn btn-lg fa fa-arrow-circle-left"
                        ...
                        @endif
                        @if ($step == 4)
                            <div class="row  {{ $step != 4 ? 'display-none' : '' }} overflow-auto" id="step-4">
                                <div class="col-md-12">
                        ...
                        @endif
                        @if ($step == 5)
                            <div class="row  {{ $step != 5 ? 'display-none' : '' }} overflow-auto" id="step-5">
                                <div class="col-md-12">
                        ...
                        @endif
                        @if ($step == 6)
                            <div class="row  {{ $step != 6 ? 'display-none' : '' }} overflow-auto" id="step-6">
                                <div class="col-md-12">
                                    ...
                                    <div class="border border-success rounded overflow-auto p-3">
                                        ...
                                        <div class="container">
                                            <div class="btn-group float-right" role="group">
                                                <button class="btn-success  nextBtn btn-lg fa fa-arrow-circle-right"
                                                    wire:click="saveLisHmisReport">Finish</button>
                                            </div>
                                            <div class="btn-group" role="group">
                                                <x-button
                                                    class="btn-danger float-right nextBtn btn-lg fa fa-arrow-circle-left"
