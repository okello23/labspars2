  ...
  <div class="mt-4 col-md-4">
    <a type="button" class="btn btn-sm btn-outline-success me-2" wire:click="export()"><i
      ...
      <a type="button" class="btn btn-outline-info me-2" wire:click="accessionSamples"><i
        class="fa fa-edit" title="Accession Samples"></i> Accession Samples</a>

      <a type="button" class="btn btn-outline-warning me-2" wire:click="archiveSamples"><i
        class="fa fa-archive" title="Accession Samples"></i> Archive Samples</a>
