...
class FacilityVisitDetailsComponent extends Component
{
    ...
    public function mount($code)
    {
        ...
        // $this->secondStepSubmit(0);
        // $this->thirdStepSubmit(0);
        // $this->fourthStepSubmit(0);
        // $this->fifthStepSubmit(0);
    ...
    public $storage_condition_score;
    ...
    public $system_for_storage_total = null;
    ...
    public $main_temperature_regulated;
    public $lab_temperature_regulated;
    public $main_roof_condition;
    public $lab_roof_condition;
    public $main_sufficient_storage_space;
    public $lab_sufficient_storage_space;
    public $main_fire_safety_equipment_available;
    public $lab_fire_safety_equipment_available;
    public $main_cold_storage_functional;
    public $lab_cold_storage_functional;
    public $main_fridge_well_ventilated;
    public $lab_fridge_well_ventilated;
    public $main_fridge_used_for_reagents_only;
    public $lab_fridge_used_for_reagents_only;
    public $main_containers_securely_capped;
    public $lab_containers_securely_capped;
    public $main_fridge_temperature_monitored;
    public $lab_fridge_temperature_monitored;
    public $main_boxes_not_on_floor;
    public $lab_boxes_not_on_floor;
    ...
    public function saveStorageCondition()
    {
        $this->validate([
            ...
            'main_temperature_regulated'           => 'required',
            'lab_temperature_regulated'            => 'required',
            'main_roof_condition'                  => 'required',
            'lab_roof_condition'                   => 'required',
            'main_sufficient_storage_space'        => 'required',
            'lab_sufficient_storage_space'         => 'required',
            'main_fire_safety_equipment_available' => 'required',
            'lab_fire_safety_equipment_available'  => 'required',
            'main_cold_storage_functional'         => 'required',
            'lab_cold_storage_functional'          => 'required',
            'main_fridge_well_ventilated'          => 'required',
            'lab_fridge_well_ventilated'           => 'required',
            'main_fridge_used_for_reagents_only'   => 'required',
            'lab_fridge_used_for_reagents_only'    => 'required',
            'main_containers_securely_capped'      => 'required',
            'lab_containers_securely_capped'       => 'required',
            'main_fridge_temperature_monitored'    => 'required',
            'lab_fridge_temperature_monitored'     => 'required',
            'main_boxes_not_on_floor'              => 'required',
            'lab_boxes_not_on_floor'               => 'required',
        ...
        FvStorageConditionManagement::updateOrCreate(
            ...
            [
                ...
                'main_temperature_regulated'           => $this->main_temperature_regulated,
                'lab_temperature_regulated'            => $this->lab_temperature_regulated,
                'main_roof_condition'                  => $this->main_roof_condition,
                'lab_roof_condition'                   => $this->lab_roof_condition,
                'main_sufficient_storage_space'        => $this->main_sufficient_storage_space,
                'lab_sufficient_storage_space'         => $this->lab_sufficient_storage_space,
                'main_fire_safety_equipment_available' => $this->main_fire_safety_equipment_available,
                'lab_fire_safety_equipment_available'  => $this->lab_fire_safety_equipment_available,
                'main_cold_storage_functional'         => $this->main_cold_storage_functional,
                'lab_cold_storage_functional'          => $this->lab_cold_storage_functional,
                'main_fridge_well_ventilated'          => $this->main_fridge_well_ventilated,
                'lab_fridge_well_ventilated'           => $this->lab_fridge_well_ventilated,
                'main_fridge_used_for_reagents_only'   => $this->main_fridge_used_for_reagents_only,
                'lab_fridge_used_for_reagents_only'    => $this->lab_fridge_used_for_reagents_only,
                'main_containers_securely_capped'      => $this->main_containers_securely_capped,
                'lab_containers_securely_capped'       => $this->lab_containers_securely_capped,
                'main_fridge_temperature_monitored'    => $this->main_fridge_temperature_monitored,
                'lab_fridge_temperature_monitored'     => $this->lab_fridge_temperature_monitored,
                'main_boxes_not_on_floor'              => $this->main_boxes_not_on_floor,
                'lab_boxes_not_on_floor'               => $this->lab_boxes_not_on_floor,
            ]
        );
        $this->dispatchBrowserEvent('close-modal');
        $this->resetInputs();
    ...
    public $main_opened_bottles_have_lids;
    public $lab_opened_bottles_have_lids;
    public $main_chemicals_properly_labelled;
    public $lab_chemicals_properly_labelled;
    public $main_flammables_stored_safely;
    public $lab_flammables_stored_safely;
    public $main_corrosives_separated;
    public $lab_corrosives_separated;
    public $main_safety_data_sheets_available;
    public $lab_safety_data_sheets_available;
    public function saveStoragePractices()
    {
        $this->validate([
            ...
            'main_opened_bottles_have_lids'     => 'required',
            'lab_opened_bottles_have_lids'      => 'required',
            'main_chemicals_properly_labelled'  => 'required',
            'lab_chemicals_properly_labelled'   => 'required',
            'main_flammables_stored_safely'     => 'required',
            'lab_flammables_stored_safely'      => 'required',
            'main_corrosives_separated'         => 'required',
            'lab_corrosives_separated'          => 'required',
            'main_safety_data_sheets_available' => 'required',
            'lab_safety_data_sheets_available'  => 'required',
        ...
        FvStoragePracticeManagement::updateOrCreate(
            ...
            [
                ...
                'main_opened_bottles_have_lids'     => $this->main_opened_bottles_have_lids,
                'lab_opened_bottles_have_lids'      => $this->lab_opened_bottles_have_lids,
                'main_chemicals_properly_labelled'  => $this->main_chemicals_properly_labelled,
                'lab_chemicals_properly_labelled'   => $this->lab_chemicals_properly_labelled,
                'main_flammables_stored_safely'     => $this->main_flammables_stored_safely,
                'lab_flammables_stored_safely'      => $this->lab_flammables_stored_safely,
                'main_corrosives_separated'         => $this->main_corrosives_separated,
                'lab_corrosives_separated'          => $this->lab_corrosives_separated,
                'main_safety_data_sheets_available' => $this->main_safety_data_sheets_available,
                'lab_safety_data_sheets_available'  => $this->lab_safety_data_sheets_available,
    ...
    public function firstStepSubmit($nxt = true)
    {
    ...
    public function loadStorageMgt()
    {
        ...
        $this->main_temperature_regulated           = $condition->main_temperature_regulated ?? null;
        $this->lab_temperature_regulated            = $condition->lab_temperature_regulated ?? null;
        $this->main_roof_condition                  = $condition->main_roof_condition ?? null;
        $this->lab_roof_condition                   = $condition->lab_roof_condition ?? null;
        $this->main_sufficient_storage_space        = $condition->main_sufficient_storage_space ?? null;
        $this->lab_sufficient_storage_space         = $condition->lab_sufficient_storage_space ?? null;
        $this->main_fire_safety_equipment_available = $condition->main_fire_safety_equipment_available ?? null;
        $this->lab_fire_safety_equipment_available  = $condition->lab_fire_safety_equipment_available ?? null;
        $this->main_cold_storage_functional         = $condition->main_cold_storage_functional ?? null;
        $this->lab_cold_storage_functional          = $condition->lab_cold_storage_functional ?? null;
        $this->main_fridge_well_ventilated          = $condition->main_fridge_well_ventilated ?? null;
        $this->lab_fridge_well_ventilated           = $condition->lab_fridge_well_ventilated ?? null;
        $this->main_fridge_used_for_reagents_only   = $condition->main_fridge_used_for_reagents_only ?? null;
        $this->lab_fridge_used_for_reagents_only    = $condition->lab_fridge_used_for_reagents_only ?? null;
        $this->main_containers_securely_capped      = $condition->main_containers_securely_capped ?? null;
        $this->lab_containers_securely_capped       = $condition->lab_containers_securely_capped ?? null;
        $this->main_fridge_temperature_monitored    = $condition->main_fridge_temperature_monitored ?? null;
        $this->lab_fridge_temperature_monitored     = $condition->lab_fridge_temperature_monitored ?? null;
        $this->main_boxes_not_on_floor              = $condition->main_boxes_not_on_floor ?? null;
        $this->lab_boxes_not_on_floor               = $condition->lab_boxes_not_on_floor ?? null;
    ...
    public function thirdStepSubmit($nxt = 1)
    {
    ...
    public function storUtilization()
    {
        ...
        FvEquipmentUtilization::updateOrCreate(
            ['visit_id'    => $this->active_visit->id,
                'equipment_id' => $this->equipment_id,
            ],
            [
    ...
    public function fifthStepSubmit($nxt = 1)
    {
        $this->validate([
    ...
    public function loadLimsData()
    {
        ...
        $this->last_report_filling_date        = $lims->last_report_filling_date ?? null;
    ...
    public function saveLisHmisReport()
    {
        $this->validate([
            ...
            'last_report_filling_date'        => 'required|date',
        ...
        FvLisHmisReport::updateOrCreate(
            ...
            [
                ...
                'last_report_filling_date'        => $this->last_report_filling_date,
